var Jodi={};
	...
	Jodi.upperArray=[];
	Jodi.lowerArray=[];
	Jodi.onScreenElements=[];
	Jodi.jsonDataUpper;
	Jodi.jsonDataLower;
	Jodi.elementLength=15;
	...
	$(".buttonClass").on("click", function() {
		...
		if($("#upper"+(Jodi.upperFirst+num)).attr("value") == $("#lower"+(Jodi.lowerFirst+(3-num))).attr("value")){
				...
				setTimeout(function(){
 					var ran=0,flag=true;
					while(flag){
						ran=Jodi.randomGenerator();
						if((Jodi.jsonDataUpper[Jodi.upperArray[ran%Jodi.elementLength]].objType == "image" && $("#upper"+(Jodi.upperFirst+num)).children().length == 0) || (Jodi.jsonDataUpper[Jodi.upperArray[ran%Jodi.elementLength]].objType == "text" && $("#upper"+(Jodi.upperFirst+num)).children().length > 0) ){
							flag=true;
						}
						else{
							flag=false;
					...
					if(Jodi.jsonDataUpper[Jodi.upperArray[ran%Jodi.elementLength]].objType == "image" && $("#upper"+(Jodi.upperFirst+num)).children().length > 0 ){
					...
					}else if(Jodi.jsonDataUpper[Jodi.upperArray[ran%Jodi.elementLength]].objType == "text" && $("#upper"+(Jodi.upperFirst+num)).children().length == 0){
						//set text div
						$("#upper"+(Jodi.upperFirst+num)).html(Jodi.jsonDataUpper[Jodi.upperArray[ran%Jodi.elementLength]].Text);
						$("#upper"+(Jodi.upperFirst+num)).attr("value",Jodi.jsonDataUpper[Jodi.upperArray[ran%Jodi.elementLength]].matchType);
						$("#upper"+(Jodi.upperFirst+num)).addClass("divSize");
					}
					
					ran=0;flag=true;
					while(flag){
						ran=Jodi.randomGenerator();
						if((Jodi.jsonDataLower[Jodi.lowerArray[ran%Jodi.elementLength]].objType == "image" && $("#lower"+(Jodi.lowerFirst+num)).children().length == 0) || (Jodi.jsonDataLower[Jodi.lowerArray[ran%Jodi.elementLength]].objType == "text" && $("#lower"+(Jodi.lowerFirst+num)).children().length > 0) ){
						flag=true;
						}
						else{
							flag=false;
					...
					if(Jodi.jsonDataLower[Jodi.lowerArray[ran%Jodi.elementLength]].objType == "image" && $("#lower"+(Jodi.lowerFirst+num)).children().length > 0 ){
					...
					}else if(Jodi.jsonDataLower[Jodi.lowerArray[ran%Jodi.elementLength]].objType == "text" && $("#lower"+(Jodi.lowerFirst+num)).children().length == 0){
						// set text div
						$("#lower"+(Jodi.lowerFirst+(3-num))).html(Jodi.jsonDataLower[Jodi.lowerArray[ran%Jodi.elementLength]].Text);
						$("#lower"+(Jodi.lowerFirst+(3-num))).attr("value",Jodi.jsonDataLower[Jodi.lowerArray[ran%Jodi.elementLength]].matchType);
						$("#lower"+(Jodi.lowerFirst+(3-num))).addClass("divSize");
					}
...
Jodi.createDivs=function(){
	...
	for(Jodi.upperCnt=0;Jodi.upperCnt<4;Jodi.upperCnt++){
		if(Jodi.jsonDataUpper[Jodi.upperArray[Jodi.upperCnt]].objType == "image"){
				...
				upperDiv=$('<div id="upper'+Jodi.upperCnt+'" class="sameHeight upper divSize col-sm-3 col-xs-3 col-md-3 col-lg-3" value='+Jodi.jsonDataUpper[Jodi.upperArray[Jodi.upperCnt]].matchType+'>'+Jodi.jsonDataUpper[Jodi.upperArray[Jodi.upperCnt]].Text+'</div>');
		}
	...
	for(Jodi.lowerCnt=0;Jodi.lowerCnt<4;Jodi.lowerCnt++){
		if(Jodi.jsonDataLower[Jodi.lowerArray[Jodi.lowerCnt]].objType == "image"){
				...
				lowerDiv=$('<div id="lower'+Jodi.lowerCnt+'" class="sameHeight lower divSize col-sm-3 col-xs-3 col-md-3 col-lg-3" value='+Jodi.jsonDataLower[Jodi.lowerArray[Jodi.lowerCnt]].matchType+'>'+Jodi.jsonDataLower[Jodi.lowerArray[Jodi.lowerCnt]].Text+'</div>');	
		}
					...
					$(".upper").animate({
					  left: '-=' + 342
						...
						if(Jodi.jsonDataUpper[Jodi.upperArray[Jodi.upperCnt%Jodi.elementLength]].objType == "image"){
							...
							$("#leftScrolling").append('<div id="upper'+Jodi.upperCnt+'" class="sameHeight upper divSize col-sm-3 col-xs-3 col-md-3 col-lg-3" value='+Jodi.jsonDataUpper[Jodi.upperArray[Jodi.upperCnt%Jodi.elementLength]].matchType+'>'+Jodi.jsonDataUpper[Jodi.upperArray[Jodi.upperCnt%Jodi.elementLength]].Text+'</div>');
						}
					...
					$(".lower").animate({
					  left: '+=' + 342
						...
						if(Jodi.jsonDataLower[Jodi.lowerArray[Jodi.lowerCnt%Jodi.elementLength]].objType == "image"){
							...
							$("#rightScrolling").prepend('<div id="lower'+Jodi.lowerCnt+'" class="sameHeight lower divSize col-sm-3 col-xs-3 col-md-3 col-lg-3" value='+Jodi.jsonDataLower[Jodi.lowerArray[Jodi.lowerCnt%Jodi.elementLength]].matchType+'>'+Jodi.jsonDataLower[Jodi.lowerArray[Jodi.lowerCnt%Jodi.elementLength]].Text+'</div>');
						}
...
Jodi.randomGenerator=function(){
		return (Math.floor(Math.random() * Jodi.elementLength) + 0) ;
};