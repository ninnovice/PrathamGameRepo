	...
	setTimeout(function()
	{
		...
		else
		{
			...
			if(Recognize.correctAnswerCount>3)
			{
				setTimeout(function()
				{
					$('#divContainingSplitImages').fadeOut(1000);
					setTimeout(function(){
						...
						document.getElementById('playSound').play();
						$('#myModal').css({'background-Image':'url('+Utils.Path+'Images/LastImg.jpg)'});
						setTimeout(function(){
			...
			else
			{
				...
				setTimeout(function()
				{
					...
					setTimeout(function(){
						...
						document.getElementById('playSound').play();
						$('#myModal').css({'background-Image':'url('+Utils.Path+'Images/joker.jpg)'});
						setTimeout(function(){
							$('#divContainingSplitImages').fadeIn();
							$('#playAgain').show().addClass('blink_me');
							$('#myModal').css({'z-index':-1});
