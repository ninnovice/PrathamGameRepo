...
dhoom.addMediaSources = function(){
    ...
    $('#frameDivider').css("background-image", "url("+Utils.Path+"images/BodyBG2.jpg");
...
//		ansData = genie.getGenieReadyData("Yes", 10);
//		genie.addScore(dhoom.questionNumber.toString(), "Maths", dhoom.currentLevel, ansData);
...
//		ansData = genie.getGenieReadyData("No", 0);
//		genie.addScore(dhoom.questionNumber.toString(), "Maths", dhoom.currentLevel, ansData);
